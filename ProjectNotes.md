...
**Coverage & freshness:** the 2.0 GIS layers grow daily — measured across three
consecutive reconciliation runs, roughly **40 clearances a day** are granted across EC, FC
and CRZ combined (+424 over the 11 days to 19 Aug 2026, +266 over the 6 days to 25 Aug).
Every count in this document is therefore a **snapshot**,
as at the **25 Aug 2026** refresh, and will already be low by the time you read it.
