...
*Status: v1.3 built and verified. Document compiled 10 Aug 2026, revised 25 Aug 2026.*
*The map now refreshes itself weekly, so the counts below are a point-in-time reading —
see §2 Coverage & freshness.*
...
arrive in every reconciliation run. Every count in this document is therefore a
**snapshot**, as at the **25 Aug 2026** refresh, and will already be low by the time you
read it. No average rate is quoted: grants appear to arrive in bursts tied to committee
sittings rather than evenly, and a handful of runs over a few weeks is not enough
observation to characterise that.
